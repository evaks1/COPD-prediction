...
| I-03 | 🟠 High | **GOLD label over-strict**: FEV1/FVC < 0.70 required across ALL spirometry tests. A patient with one obstructive and one normal test is labelled negative, contradicting GOLD 2024. | `train_model.py`, label derivation | Some COPD-positive patients are mislabelled as negative in training. |
...
| Specificity | TBD | TBD | TBD | TBD |
| Precision (PPV) | TBD | TBD | TBD | TBD |
| ROC-AUC | TBD | TBD | TBD | TBD |
| PR-AUC | TBD | TBD | TBD | TBD |
| Brier Score | TBD | TBD | TBD | TBD |
| F1 | TBD | TBD | TBD | TBD |
| Threshold | TBD | TBD | TBD | TBD |

**Selected model**: TBD
**Rationale for selection**: TBD
**Comparison vs Iteration 1**: TBD (note: direct comparison is not valid, as they use different target variables and different training populations)
